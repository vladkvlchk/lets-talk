...
const AddContactModal: React.FC<AddContactModalType> = ({ onClose }) => {
  ...
  return (
    <>
      ...
      <div className="absolute w-1/3 translate-y-1/2 translate-x-1/2 bottom-1/2 right-1/2 bg-slate-950 rounded-xl z-10 text-white">
